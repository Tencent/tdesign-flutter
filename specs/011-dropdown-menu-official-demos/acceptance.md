...
| `flutter test --no-pub test/dropdown_menu_page_test.dart` | PASS，3 tests | Flutter 3.32.0；仅保留官方矩阵与禁用交互 |
| `flutter analyze --fatal-infos --no-pub` | PASS | Flutter 3.32.0，0 issues |
| `flutter test --no-pub test/dropdown_menu_page_test.dart` | PASS，3 tests | Flutter 3.47.0 |
