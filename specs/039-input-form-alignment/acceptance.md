...
Linux Golden 已覆盖标签字号、前后插槽间距、目标表单垂直对齐及图形/
手机号验证码分割线契约，但不以此替代设计稿人工验收。
