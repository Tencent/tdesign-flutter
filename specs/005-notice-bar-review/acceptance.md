...
| Flutter 3.32.0 `flutter test --no-pub test/components/notice_bar/t_notice_bar_test.dart --coverage` | PASS，45 tests；NoticeBar `LH=245` / `LF=255` = 96.08% |
...
- [x] 双版本严格 analyze 通过。
- [x] 生产源码覆盖率为 96.08%（`LH=245` / `LF=255`），高于 95%。
