...
| 公开 Demo 滚动态 | 同一 Figma 节点的圆形 / 半圆形移动端展示 | `backtop_page_circle_scrolled_{light,dark}.png`、`backtop_page_half-round_scrolled_{light,dark}.png` | 固定视口内真实滚动后由单个组件呈现对应悬浮形态 |
