...
- [x] 修复 Tag 单行文字行盒、统一边框槽位、尺寸化图标和关闭图标语义色。
- [x] 补齐 Tag 尺寸／变体／字体缩放测试，并完成双版本非视觉门禁。
- [x] 更新 Linux Flutter 3.32.0 Tag Demo Golden，并无更新参数复跑。
- [x] 按设计稿补齐 Tag Demo 导航栏文案、说明标点与圆弧／Mark 三实例布局，并重新完成像素比对。
