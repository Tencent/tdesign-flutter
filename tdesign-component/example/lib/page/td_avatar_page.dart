...
class _TDAvatarPageState extends State<TDAvatarPage> {
  ...
  Widget _buildTextAvatar(BuildContext context) {
    return const Padding(
      ...
      child: Row(
        children: [
          TDAvatar(size: TDAvatarSize.medium, type: TDAvatarType.customText, text: 'A'),
          SizedBox(
            width: 32,
          ),
          TDAvatar(
    ...
    return const Padding(
      ...
      child: Row(
        children: [
          ...
          TDAvatar(size: TDAvatarSize.large, type: TDAvatarType.customText, text: 'A'),
          SizedBox(
            width: 32,
          ),
          TDAvatar(
    ...
    return const Padding(
      ...
      child: Row(
        children: [
          ...
          TDAvatar(size: TDAvatarSize.small, type: TDAvatarType.customText, text: 'A'),
          SizedBox(
            width: 56,
          ),
          TDAvatar(
