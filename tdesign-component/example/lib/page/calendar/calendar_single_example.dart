              ...
              child: Column(
                children: [
                  if (showMonthSwitcher)
                    CalendarSingleExampleCalendarMonthSwitcher(
                      month: anchor,
                      minDate: start,
                      maxDate: end,
...
class CalendarSingleExampleCalendarMonthSwitcher extends StatelessWidget {
  const CalendarSingleExampleCalendarMonthSwitcher({
    super.key,
    required this.month,
