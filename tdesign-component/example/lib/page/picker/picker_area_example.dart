...
class PickerAreaExample extends StatefulWidget {
  const PickerAreaExample({super.key});

  @override
  State<PickerAreaExample> createState() => _PickerAreaExampleState();
}

class _PickerAreaExampleState extends State<PickerAreaExample> {
