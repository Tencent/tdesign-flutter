...
void main() {
  ...
  for (final mode in [ThemeMode.light, ThemeMode.dark]) {
    ...
    testWidgets('table selection changed ${mode.name} golden', (tester) async {
      ...
      await expectLater(
        selectable,
        matchesGoldenFile('goldens/table_selection_changed_${mode.name}.png'),
      );
      await disposeDemoPage(tester);
    }, tags: 'golden');
    ...
    testWidgets('table fixed columns scrolled ${mode.name} golden', (
      ...
      await expectLater(
        ...
        matchesGoldenFile('goldens/table_fixed_scrolled_${mode.name}.png'),
      );
      await disposeDemoPage(tester);
    }, tags: 'golden');
    ...
    testWidgets('table max height scrolled ${mode.name} golden', (
      ...
      await expectLater(
        find.byKey(const ValueKey('table-demo-page')),
        matchesGoldenFile('goldens/table_max_height_scrolled_${mode.name}.png'),
      );
      await disposeDemoPage(tester);
    }, tags: 'golden');
  }
