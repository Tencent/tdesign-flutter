...
void main() {
  ...
  group('TRate controlled behavior', () {
    testWidgets('renders zero, whole and half values', (tester) async {
      ...
      final align = tester.widgetList<Align>(find.byType(Align)).firstWhere(
            (widget) => widget.widthFactor == 0.5,
          );
  ...
  group('TRate content and theme', () {
    ...
    testWidgets('text supports whole, half and fallback indexes',
      ...
      await tester.pumpWidget(wrap(
        const TRate(value: 0, texts: whole),
        rateTheme: theme,
      ));
      expect(find.text('0.0'), findsOneWidget);

      await tester.pumpWidget(wrap(
        const TRate(value: 5, texts: ['short']),
        rateTheme: theme,
      ));
