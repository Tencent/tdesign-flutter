          ...
          child: Container(
            ...
            child: Center(
                child: Icon(icon ?? TDIcons.user,
                    size: _getIconWidth(), color: TDTheme.of(context).brandNormalColor)),
          ),
          onTap: onTap,
        );
                ...
                child: Container(
                    ...
                    decoration: ShapeDecoration(
                      ...
                      shape: RoundedRectangleBorder(
                          borderRadius:
                              BorderRadius.circular(_getAvatarWidth() - _getDisplayPadding()),
                          side: BorderSide(color: Colors.transparent, width: avatarDisplayBorder)),
                    )),
              )));
        } else {
          list.add(Positioned(
              ...
              child: Container(
                  ...
                  decoration: ShapeDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(avatarDisplayList![i]), fit: fit ?? BoxFit.cover)))));
        }
      }
