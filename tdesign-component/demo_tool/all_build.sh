...
# picker
dart run tdesign_flutter_tools:main generate --folder "$PARENT_DIR/lib/src/components/picker" --name TPicker,PickerOption,PickerValue,PickerColumns,PickerLinked,PickerItems,PickerKeys --folder-name picker --output "$PARENT_DIR/example/assets/api/" --only-api
# date-time-picker
