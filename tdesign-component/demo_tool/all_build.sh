...
# link
./bin/demo_tool generate --file ../lib/src/components/link/td_link.dart --name TDLink --folder-name link --output ../example/assets/api/ --only-api
# text
...
# slider
./bin/demo_tool generate --file ../lib/src/components/slider/td_slider.dart --name TDSlider,TDRangeSlider,TDSliderThemeData --folder-name slider --output ../example/assets/api/ --only-api
# stepper
./bin/demo_tool generate --file ../lib/src/components/stepper/td_stepper.dart --name TDStepper --folder-name stepper --output ../example/assets/api/ --only-api
# switch
...
# imageViewer
./bin/demo_tool generate --file ../lib/src/components/image_viewer  --name TDImageViewer, TDImageViewerWidget  --folder-name image --output ../example/assets/api/ --only-api
# progress
# result
# skeleton
# sticky
