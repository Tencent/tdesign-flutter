...
# date-time-picker
dart run tdesign_flutter_tools:main generate --folder "$PARENT_DIR/lib/src/components/date_time_picker" --name TDateTimePicker,DateTimePickerMode,TDateTimePickerValue,DateTimePickerSteps --folder-name date-time-picker --output "$PARENT_DIR/example/assets/api/" --only-api --get-comments
# form
