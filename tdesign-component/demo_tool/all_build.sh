...
# divider
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/divider/td_divider.dart" --name TDivider --folder-name divider --output "$PARENT_DIR/example/assets/api/" --only-api
# fab
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/fab/td_fab.dart" --name TFab --folder-name fab --output "$PARENT_DIR/example/assets/api/" --only-api
# icon
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/icon/td_icons.dart" --name TIcons --folder-name icon --output "$PARENT_DIR/example/assets/api/" --only-api
# link
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/link/td_link.dart" --name TLink --folder-name link --output "$PARENT_DIR/example/assets/api/" --only-api
# text
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/text/td_text.dart" --name TText,TTextSpan,TTextConfiguration --folder-name text --output "$PARENT_DIR/example/assets/api/" --only-api


# 导航
# back_top
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/backtop/td_backtop.dart" --name TBackTop --folder-name back-top --output "$PARENT_DIR/example/assets/api/" --only-api
# drawer
...
# navbar
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/navbar/td_nav_bar.dart" --name TNavBar,TNavBarItem, --folder-name navbar --output "$PARENT_DIR/example/assets/api/" --only-api
# sidebar
...
# input
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/input/td_input.dart" --name TInput, TInputSpacer --folder-name input --output "$PARENT_DIR/example/assets/api/" --only-api
# picker
...
# radio
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/radio/td_radio.dart" --name TRadioStyle,TRadio,TRadioGroup --folder-name radio --output "$PARENT_DIR/example/assets/api/" --only-api --get-comments
# rate
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/rate/td_rate.dart" --name TRate --folder-name rate --output "$PARENT_DIR/example/assets/api/" --only-api
# search
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/search/td_search_bar.dart" --name TSearchBar --folder-name search --output "$PARENT_DIR/example/assets/api/" --only-api
# slider
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/slider/td_slider.dart" --name TSlider,TRangeSlider,TSliderThemeData --folder-name slider --output "$PARENT_DIR/example/assets/api/" --only-api
# stepper
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/stepper/td_stepper.dart" --name TStepper --folder-name stepper --output "$PARENT_DIR/example/assets/api/" --only-api
# switch
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/switch/td_switch.dart" --name TSwitch --folder-name switch --output "$PARENT_DIR/example/assets/api/" --only-api
# textarea
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/textarea/td_textarea.dart" --name TTextarea --folder-name textarea --output "$PARENT_DIR/example/assets/api/" --only-api --get-comments
# tree_select
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/tree/td_tree_select.dart" --name TTreeSelect,TSelectOption --folder-name tree-select --output "$PARENT_DIR/example/assets/api/" --only-api

# upload
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/upload/td_upload.dart" --name TUpload --folder-name upload --output "$PARENT_DIR/example/assets/api/" --only-api


# 数据展示
# avatar
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/avatar/td_avatar.dart" --name TAvatar --folder-name avatar --output "$PARENT_DIR/example/assets/api/" --only-api
# badge
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/badge/td_badge.dart" --name TBadge --folder-name badge --output "$PARENT_DIR/example/assets/api/" --only-api
# cell
...
# empty
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/empty/td_empty.dart" --name TEmpty --folder-name empty --output "$PARENT_DIR/example/assets/api/" --only-api
# footer
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/footer/td_footer.dart" --name TFooter,TFooterType --folder-name footer --output "$PARENT_DIR/example/assets/api/" --only-api

# grid
# image
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/image/td_image.dart" --name TImage --folder-name image --output "$PARENT_DIR/example/assets/api/" --only-api
# imageViewer
...
# progress
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/progress/td_progress.dart" --name TProgress --folder-name progress --output "$PARENT_DIR/example/assets/api/" --only-api
# result
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/result/td_result.dart" --name TResult --folder-name result --output "$PARENT_DIR/example/assets/api/" --only-api
# skeleton
...
# loading
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/loading/td_loading.dart" --name TLoading --folder-name loading --output "$PARENT_DIR/example/assets/api/" --only-api
# message
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/message/td_message.dart" --name TMessage,MessageTheme,MessageMarquee,MessageLink --folder-name message --output "$PARENT_DIR/example/assets/api/" --only-api
# noticeBar
...
# refresh
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/refresh/td_refresh_header.dart" --name TRefreshHeader --folder-name pull-down-refresh --output "$PARENT_DIR/example/assets/api/" --only-api --get-comments
# swipecell
...
# toast
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/components/toast/td_toast.dart" --name TToast --folder-name toast --output "$PARENT_DIR/example/assets/api/" --only-api


# 其他
# theme
dart run tdesign_flutter_tools:main generate --file "$PARENT_DIR/lib/src/theme/td_theme.dart" --name TTheme,TThemeData --folder-name theme --output "$PARENT_DIR/example/assets/api/" --only-api
# radius
