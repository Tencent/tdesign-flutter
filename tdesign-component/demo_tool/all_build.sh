# 基础
# button
./bin/api_tool_linux generate --folder ../lib/src/components/button --name TDButton,TDButtonStyle --folder-name button --output ../example/assets/api/ --only-api
# divider
./bin/api_tool_linux generate --file ../lib/src/components/divider/td_divider.dart --name TDDivider --folder-name divider --output ../example/assets/api/ --only-api
# fab
./bin/api_tool_linux generate --file ../lib/src/components/fab/td_fab.dart --name TDFab --folder-name fab --output ../example/assets/api/ --only-api
# icon
./bin/api_tool_linux generate --file ../lib/src/components/icon/td_icons.dart --name TDIcons --folder-name icon --output ../example/assets/api/ --only-api
# link
./bin/api_tool_linux generate --file ../lib/src/components/link/td_link.dart --name TDLink --folder-name link --output ../example/assets/api/ --only-api
# text
...
# navbar
./bin/api_tool_linux generate --file ../lib/src/components/navbar/td_nav_bar.dart --name TDNavBar,TDNavBarItem, --folder-name navbar --output ../example/assets/api/ --only-api
# sidebar
./bin/api_tool_linux generate --folder ../lib/src/components/sidebar --name TDSideBar,TDSideBarItem, --folder-name side-bar --output ../example/assets/api/ --only-api
# steps
./bin/api_tool_linux generate --folder ../lib/src/components/steps --name TDSteps,TDStepsItemData --folder-name steps --output ../example/assets/api/ --only-api
# tabbar
./bin/api_tool_linux generate --file ../lib/src/components/tabbar/td_bottom_tab_bar.dart --name TDBottomTabBar,BadgeConfig,TDBottomTabBarTabConfig,TDBottomTabBarPopUpBtnConfig,TDBottomTabBarPopUpShapeConfig,PopUpMenuItem --folder-name tab-bar --output ../example/assets/api/ --only-api
# tabs
./bin/api_tool_linux generate --folder ../lib/src/components/tabs --name TDTabBar,TDTab,TDTabBarView --folder-name tabs --output ../example/assets/api/ --only-api
...
# cascader
./bin/api_tool_linux generate --folder ../lib/src/components/cascader --name TDMultiCascader --folder-name cascader --output ../example/assets/api/ --only-api
...
# picker
./bin/api_tool_linux generate --folder ../lib/src/components/picker --name TDPicker,TDMultiPicker,TDMultiLinkedPicker,MultiLinkedPickerModel --folder-name picker --output ../example/assets/api/ --only-api
# radio
./bin/api_tool_linux generate --file ../lib/src/components/radio/td_radio.dart --name TDRadioStyle,TDRadio,TDRadioGroup --folder-name radio --output ../example/assets/api/ --only-api --get-comments
# rate
./bin/api_tool_linux generate --file ../lib/src/components/rate/td_rate.dart --name TDRate --folder-name rate --output ../example/assets/api/ --only-api
# search
./bin/api_tool_linux generate --file ../lib/src/components/search/td_search_bar.dart --name TDSearchBar --folder-name search --output ../example/assets/api/ --only-api
# slider
./bin/api_tool_linux generate --file ../lib/src/components/slider/td_slider.dart --name TDSlider,TDRangeSlider,TDSliderThemeData --folder-name slider --output ../example/assets/api/ --only-api
# stepper
./bin/api_tool_linux generate --file ../lib/src/components/stepper/td_stepper.dart --name TDStepper --folder-name stepper --output ../example/assets/api/ --only-api
# switch
./bin/api_tool_linux generate --file ../lib/src/components/switch/td_switch.dart --name TDSwitch --folder-name switch --output ../example/assets/api/ --only-api
# textarea
./bin/api_tool_linux generate --file ../lib/src/components/textarea/td_textarea.dart --name TDTextarea --folder-name textarea --output ../example/assets/api/ --only-api --get-comments
# tree_select
./bin/api_tool_linux generate --file ../lib/src/components/tree/td_tree_select.dart --name TDTreeSelect,TDSelectOption --folder-name tree-select --output ../example/assets/api/ --only-api

# upload
./bin/api_tool_linux generate --file ../lib/src/components/upload/td_upload.dart --name TDUpload --folder-name upload --output ../example/assets/api/ --only-api


# 数据展示
# avatar
./bin/api_tool_linux generate --file ../lib/src/components/avatar/td_avatar.dart --name TDAvatar --folder-name avatar --output ../example/assets/api/ --only-api
# badge
./bin/api_tool_linux generate --file ../lib/src/components/badge/td_badge.dart --name TDBadge --folder-name badge --output ../example/assets/api/ --only-api
# cell
./bin/api_tool_linux generate --folder ../lib/src/components/cell --name TDCell,TDCellGroup,TDCellStyle --folder-name cell --output ../example/assets/api/ --only-api --get-comments
# timeCounter
./bin/api_tool_linux generate --folder ../lib/src/components/time_counter --name TDTimeCounter,TDTimeCounterController,TDTimeCounterStyle --folder-name time-counter --output ../example/assets/api/ --only-api --get-comments
# collapse
./bin/api_tool_linux generate --folder ../lib/src/components/collapse --name TDCollapse --folder-name collapse --output ../example/assets/api/ --only-api --get-comments
...
# table
./bin/api_tool_linux generate --folder ../lib/src/components/table --name TDTable,TDTableCol --folder-name table --output ../example/assets/api/ --only-api
# tag
...
# refresh
./bin/api_tool_linux generate --file ../lib/src/components/refresh/td_refresh_header.dart --name TDRefreshHeader --folder-name pull-down-refresh --output ../example/assets/api/ --only-api --get-comments
# swipecell
./bin/api_tool_linux generate --folder ../lib/src/components/swipe_cell --name TDSwipeAction,TDSwipeAutoClose,TDSwipeCell,TDSwipePanel --folder-name swipe-cell --output ../example/assets/api/ --only-api --get-comments
# toast
