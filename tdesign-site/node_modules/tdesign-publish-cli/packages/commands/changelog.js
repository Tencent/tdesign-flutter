...
function updateVersion() {
  return new Promise((resolve) => {
    ...
    rl.on('line', (input) => {
      ...
      fs.writeFileSync(`${rootPath}/package.json`, `${newPkg}\n`, 'utf8');
...
async function updateChangeLog() {
  if (!fs.existsSync(readmeFilePath)) {
    console.log('\x1b[33m%s\x1b[0m', `未找到 ${readmeFilePath} ，已创建文件...`);
    return;
  }
  await updateVersion();
  ...
  let initialChangelogStr = fs.readFileSync(`${rootPath}/CHANGELOG.md`, 'utf8');
  ...
  new Promise((resolve) => {
    ...
    const writeStream = fs.createWriteStream(`${rootPath}/CHANGELOG.md`, 'utf8');
