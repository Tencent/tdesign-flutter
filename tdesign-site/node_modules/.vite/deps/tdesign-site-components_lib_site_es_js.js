...
// ../node_modules/tdesign-site-components/lib/site.es.js
var require_site_es = __commonJS({
  "../node_modules/tdesign-site-components/lib/site.es.js"(exports, module) {
    ...
    var hasAdoptedStylesheets = !!global$1.document.adoptedStyleSheets;
    var NUMBER_REGEXP = /^\d+$/;
    var rules = {
      block: (props, align) => ({
        display: "block",
...
${beautifyTemplateLog(signature, marker.index)}`
    ...
    var baseComponentPrefix$2 = ["vue", "react", "mobile-vue", "mobile-react", "vue-next", "flutter", "miniprogram"];
    var headerData = {
    ...
    var baseComponentPrefix$1 = ["vue", "react", "mobile-vue", "mobile-react", "vue-next", "flutter", "miniprogram"];
    var gplHeaderData = {
    ...
    var { headerList, baseComponentsLinks, baseComponentPrefix } = isIntranet() ? headerData : gplHeaderData;
    var allComponentsNpmUrl = [
  ...
  `.css`${style$s}`
    ...
    var logoMenuConfigCdn = "https://cdc.cdn-go.cn/tdc/latest/menu.json";
    var logoMenuConfigWoaCdn = "https://cdc.cdn-go.cn/tdc/latest/menu.woa.json";
    var logoMenuSvgPrefix = "https://cdc.cdn-go.cn/tdc/latest/images";
  ...
  `.css`${style$q}`
    ...
    var apiUrl = "https://service-edbzjd6y-1257786608.hk.apigw.tencentcs.com/release/github-contributors/list";
  ...
  `;
    ...
    var storageChangeEvent = new CustomEvent("storageChange");
    ...
    var originHistoryEvent = window.history.replaceState;
...
`;
  ...
  `
    ...
    var BASE_URL = "https://tdesign.gtimg.com/site";
    var splineConfig = {
    ...
    var getIssueHelper = (framework) => `https://github.com/Tencent/tdesign-${framework}/issues/new/choose`;
    var issueUrlMap = {
  ...
  `;
    ...
    var getGithubIssueUrl = (name, state = "open", repo) => `https://api.github.com/search/issues?q=is:issue+is:${state}+${name}+repo:Tencent/${repo}`;
...
// dep:tdesign-site-components_lib_site_es_js
var tdesign_site_components_lib_site_es_js_default = require_site_es();
export {
  tdesign_site_components_lib_site_es_js_default as default
};
 ...
 * @public
 */
//# sourceMappingURL=tdesign-site-components_lib_site_es_js.js.map
