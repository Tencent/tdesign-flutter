...
const baseComponentPrefix$1 = ["vue", "react", "mobile-vue", "mobile-react", "vue-next", "flutter", "miniprogram"];
var gplHeaderData = {
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return function(modules) {
    ...
    function(module2, exports2, __webpack_require__) {
      ...
      function getFlush(callbacks, context2, args) {
        return flush;
        function flush() {
          var cancelled;
          for (var i = 0, len = callbacks.length; !cancelled && i < len; i += 1) {
            cancelled = callbacks[i].apply(context2, args) === false;
          }
          return !cancelled;
        }
      }
...
define$2({
  tag: "td-doc-footer",
  footerLinks: {
    get: (_host, lastValue) => isIntranet() ? footerLinks$1 : footerLinks,
    set: (_host, value2) => value2
  },
  mobileBodyStyle,
  platform: "web",
  ...
  render: (host) => {
    const { footerLinks: footerLinks2 } = host;
    const mobileBodyStyle2 = { ...host.mobileBodyStyle };
    return html`
