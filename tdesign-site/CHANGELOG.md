...
## 🌈 0.2.6 `2025-11-14`
### 🚀 Features
- `TNoticeBar `: 新增`content`属性，废弃并兼容原有的context属性 @runoob-coder ([#744](https://github.com/Tencent/tdesign-flutter/pull/744))
- `TButton`: 添加渐变颜色背景 @jflin19990707 ([#773](https://github.com/Tencent/tdesign-flutter/pull/773))
- `TToast`: TToast支持展示多个 @jflin19990707 ([#780](https://github.com/Tencent/tdesign-flutter/pull/780))
- `TUpload`: 增加自定义上传监听 @leenc123 ([#775](https://github.com/Tencent/tdesign-flutter/pull/775))
- `TTable`: 增加自定义表尾属性 @leenc123 ([#776](https://github.com/Tencent/tdesign-flutter/pull/776))

### 🐞 Bug Fixes
- `TMultiCascader`: 修复initialIndexes 参数不生效 @epoll-j ([#752](https://github.com/Tencent/tdesign-flutter/pull/752))
- `TDialog`: 按钮文案溢出问题 @jflin19990707 ([#772](https://github.com/Tencent/tdesign-flutter/pull/772))
- `TDateTimePicker`: 日期时分秒的英文配置改为缩写 @jflin19990707 ([#770](https://github.com/Tencent/tdesign-flutter/pull/770))
- `TCell`: TCell的note过长时溢出问题 @jflin19990707 ([#769](https://github.com/Tencent/tdesign-flutter/pull/769))
- `TCell`: 修复单元格内 icon 与文本的对齐问题 @runoob-coder ([#789](https://github.com/Tencent/tdesign-flutter/pull/789))
- `TProgress `: 修复进度条改变时的样式问题  @runoob-coder ([#744](https://github.com/Tencent/tdesign-flutter/pull/744))
